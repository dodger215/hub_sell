...
<script>
    ...
    create.addEventListener('click', () => {
        window.location.href = "createOrders.php";
    });

    async function fetchProducts() {
        try {
            const response = await fetch('api/products_data.json'); 
                        ...
                        <div class="card mb-3" style="width: 100%; height: auto;">
                            <div class="card-body">
                                ...
                                <div class="sub d-flex align-items-center mt-2 view">
                                    ...
                                    <img src="api/${product.image}" class="img-fluid rounded" style="width: 50%; max-height: 300px; object-fit: cover;">
                                </div>
